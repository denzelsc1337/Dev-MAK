...
$data[10] = $_POST["opciones_zoni_lc"];

$data[11] = $_POST["frnt_lcl_com"];
$data[12] = $_POST["coch_lcl_com"];

$data[13] = $_POST["piso_lcl_com"];

$data[14] = isset($_POST['ascen_lcl_com']) ? true : false;
$data[15] = isset($_POST['aire_lcl_com']) ? true : false;
