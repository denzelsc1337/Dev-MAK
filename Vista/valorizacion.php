                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="form-group">
                        ...
                        <select id="tipo_prop" class="form-control">
                          ...
                          ?>
                          <!-- <option value="<?php //echo $cboTypes_p[0]; 
                                              ?>"><?php //echo $cboTypes_p[1]; 
                                                                                ?></option> -->
                          <?php // } 
                          ?>
                        </select>
                  ...
                  <script type="text/javascript">
                    function updateSecondSelect() {
                      ...
                      if (tipo_prop_value_selected === "casa.php") {
                        ...
                        sub_tipo_prop.add(option1);

                        const option2 = document.createElement("option");
                        option2.value = "1-2";
                        option2.text = "De campo";
                        sub_tipo_prop.add(option2);
                    ...
                    const tipo_prop = document.getElementById("tipo_prop");
                    tipo_prop.addEventListener("change", updateSecondSelect);
                  </script>
