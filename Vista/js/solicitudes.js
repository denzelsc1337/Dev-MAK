...
//       let docs = [];
//       try {
//         docs = await documentsRead(); // Espera a que la función de carga de usuarios se complete
//       } catch (err) {
//         console.error("No se pudieron cargar los usuarios", err);
//       }
...
//   //   try {
//   //     // Realizar la solicitud AJAX para obtener el contenido de la carpeta
//   //     const response = await $.ajax({
//   //       type: "GET",
//   //       url: "../views/data.php", // Ruta al archivo PHP que devuelve los contenidos de la carpeta
//   //       data: { accion: "documentsRead" },
//   //       dataType: "json", // Indica que esperas recibir JSON
//   //     });
...
//   //     // Construir HTML dinámico para cada archivo
//   //     files.forEach((file) => {
//   //       html += `
//   //         <div class="file-item mak-bdr">
//   //             <div class="row">
//   //                 <div class="file-item-content">
//   //                     <div class="content-head">
//   //                         <div class="header">
//   //                             <span>Nombre del archivo: <b>${file}</b></span>
//   //                         </div>
//   //                     </div>
//   //                 </div>
//   //             </div>
...
//           idProp: "",
//         }, // Parámetro 'accion' para obtener usuarios
//         dataType: "json",
//         success: function (response) {
//           if (response.error) {
//             console.error("Error del servidor:", response.error);
  ...
  function loadDocuments(idProp) {
    return new Promise((resolve, reject) => {
      $.ajax({
        type: "GET",
        url: "../views/data.php",
        data: { accion: "documentsRead", idProp },
        dataType: "json",
        success: function (response) {
          if (response.error) {
            reject(response.error);
